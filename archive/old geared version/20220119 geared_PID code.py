...
enc = rotaryio.IncrementalEncoder(board.GP15,board.GP14)

encoder_counts_per_rev =  3000 #3050 #3140 #3080 #3040 #2500 #1250 #5000
...
def position_control(target_position,gains,sample_time=3.0,min_drive=mot_min_drive):
	...
	while(q):
		...
		if abs(error) > threshold:
			...
			try:
			#print((now-last_now) * conversion_factor)
