...
commands = struct('target',35,'Kp',4000,'Ki',0,'Kd',0,'runtime',1.5,'min_drive',65535)
...
for i=1:length(data)
    ...
    yerror(i)=(data(i).error) / 1.8;  %/180;
    ydir(i)=data(i).dir*100;
    %ypwm(i)=(data(i).pwm_actual - commands.min_drive)/(65535-commands.min_drive);
    ypwm(i) = (data(i).pwm_actual) / 655.35;
end
figure; hold on
