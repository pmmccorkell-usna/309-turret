...
classdef ew309 < matlab.mixin.SetGet
	...
	methods(Access='public')
		...
		function obj=ew309(varargin)
			...
			obj.Kp = 2000; %4000; for rubber wheel
			obj.Ki = 6000;
			obj.Kd = 500; %10;
			obj.runtime = 2.0;
			obj.min_drive = 15000; %20000; for rubber wheel
		...
		function read_serial(obj)
			...
			figure;
			xlabel('time (s)');
            line1 = animatedline('Color','r');line1_label = "error %";
            line2 = animatedline('Color','g');line2_label = "direction"; 
            line3 = animatedline('Color','b');line3_label = "pwm %";
			...
			while(obj.serial_device.NumBytesAvailable)
                ...
                % Uncomment for faster graphing, but less resolution
        		obj.serial_device.flush();
                ...
                addpoints(line1,xtimes(end),yerror(end)); 
                addpoints(line2,xtimes(end),ydir(end)); 
                addpoints(line3,xtimes(end),ypwm(end)); 
                drawnow;
